<template>
	<view>
		<!-- 标签 -->
		<view class="tabs-box">
			<u-tabs :current="current" :list="tagList" lineWidth="42" lineHeight="2" lineColor="#1098ad"
		...
		<u-list @scrolltolower="scrolltolower">
			<u-list-item v-for="(item, index) in indexList" :key="index">
				<my-card :is-shadow="true" padding="10px" @click="gotoPage('/pages/home/information/detail', item.id)"
					style="border-radius: 24rpx;box-shadow: 12rpx 12rpx 10rpx #bfbfbf;" >
              ...
              <u--image class="UImg" :src="item.img" radius="16rpx" shape="square" mode="aspectFill" width="110px"
                height="90px" margin="0px -16px 0px 8px"></u--image>
					...
					<view class="saidContent">
						<u--text :lines="3" :text="item.overview" size="14" color="#000" lineHeight="20px"
							class="textContent" margin="0px" padding="0px 4px" height="94px"></u--text>
						<image class="sights" :src="item.img"></image>
					</view>

					<u--text :lines="1" :text="item.readNum" size="12" color="#000" lineHeight="12px"
						margin="2px 2px"></u--text>
				</my-card>
			</u-list-item>
		</u-list>
	</view>
