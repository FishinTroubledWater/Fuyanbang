		...
		<u-row class="tabs-box">
			...
			<u-col span="6" style="margin: 0 -40rpx 0 24rpx;height: 256rpx;">
				<my-card :is-shadow="true" class="tabs-box-item" @click="gotoPage('/pages/home/university/academy')"
					style="height: 600rpx;border-radius: 24rpx;
			...
			<u-col span="6" style="margin: 0 4rpx 0 -4rpx;height: 256rpx;">
				<my-card :is-shadow="true" class="tabs-box-item" @click="gotoPage('/pages/home/professional/major')"
					style="margin-bottom: -16rpx;border-radius: 24rpx;
					box-shadow: 5rpx 5rpx 5rpx #646464;border: none;
          background-image: linear-gradient(313deg,#36d1dc,#5b86e5);">
				...
				<my-card :is-shadow="true" class="tabs-box-item" @click="gotoPage('/pages/home/information/news')"
